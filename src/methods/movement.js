...
exports._goBack = function () {
  ...
  for (var i=0; i<travels.length; i++) {
    ...
    if (!cur.tcond) {
      var remote = gu.travels(cur.tdest);
...
exports._doTravel = function () {
  ...
  for(var i=0; i<travels.length && !mvflag; i++) {
    ...
    switch (div) {
      ...
      case 1:
        // Movement is restricted to you having an object:
      ...
      case 2:
        // Movement is restricted to an object being there
      ...
      case 5:
      case 7:
        // Movement is based on an item state:
...
exports._specialMove = function (rdest) {
  switch(rdest - 300) {
    ...
    case 2:
      ...
      this._pspeak(DEF.obj.EMERALD, 0);
      this.forcePlugh = true;
      break;
    case 3:
